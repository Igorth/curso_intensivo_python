...
class RandomWalk():
	...
	def __init__(self, num_points=5000):
		...
		# Todos os passeios comea em (0,0)
		self.x_values = [0]
		self.y_values = [0]
	...
	def fill_walk(self):
		...
		# Continua dando passos ata que o passeio alcance o tamanho desejado
		while len(self.x_values) < self.num_points:

			# Decide direcao a ser seguida e distancia a ser percorrida nessa direcao
